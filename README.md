...
- **Набор по фотографии:** в разделе «Наборы» выберите фото или сделайте снимок печатного английского списка. Распознавание выполняется на телефоне. Проверьте строки, уберите лишние и проверьте автоматические переводы перед сохранением. Бесплатная модель перевода загружается при первом запуске (около 30 МБ), затем работает на телефоне. Ручные исправления сохраняются. Русский текст с фото не распознаётся.
- **Мой альбом:** восемь постоянных наклеек за занятия, освоенные слова и встречи в разные дни. Пропуск дня не отнимает наклейки; минуты Roblox считаются отдельно. Альбом входит в резервную копию.

## Скриншоты

Мобильный предпросмотр интерфейса 1.4.3. Для экрана фото использован демонстрационный список с переводами; работа камеры и моделей выполняется в Android-приложении. Все снимки одного размера, без растянутых длинных страниц.

<table>
<tr><th>Наборы</th><th>Меню набора</th></tr>
<tr><td valign="top"><img src="docs/screenshots/sets-143.png" width="285" alt="Наборы и добавление по фото"></td><td valign="top"><img src="docs/screenshots/menu-143.png" width="285" alt="Редактирование, архив и удаление набора"></td></tr>
<tr><th>Проверка перевода</th><th>Альбом</th></tr>
<tr><td valign="top"><img src="docs/screenshots/photo-143.png" width="285" alt="Редактируемый перевод слов с фотографии"></td><td valign="top"><img src="docs/screenshots/album-143.png" width="285" alt="Альбом постоянных достижений"></td></tr>
</table>
...
| ✍️ Пишу слова | Напиши слово | Пишет английское слово по переводу |
| ✍️ Пишу слова | Мини-диктант | Слушает и записывает слово |
...
Нажмите **«Написать рукой»** и пишите в отдельном поле. Задание закреплено сверху: русское слово видно во время письма и выбора результата. В мини-диктанте здесь же доступны «Послушать» и «Помедленнее», без показа английского ответа. Можно отменить последний штрих или очистить поле целиком. После нажатия «Распознать» выберите подходящий вариант, исправьте его при необходимости и нажмите «Проверить» в задании.
...
В режиме «Помедленнее» задана вдвое меньшая скорость, чем в обычном режиме. Фактическое звучание зависит от движка TTS.
...
У набора есть название, дата урока, редактирование, архив и полное удаление с подтверждением. Работа с наборами не требует PIN. Меню **«⋯»** открывается также при удержании карточки. Кнопки занятия и отправки находятся прямо в списке наборов.
...
2. Скачайте **`Mayusha-English-1.4.3-universal.apk`** из раздела Assets.
